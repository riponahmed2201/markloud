<section class="services-area pb-130 relative">
    <div class="container">
        ...
        <div class="relative">
            <img class="circle-shape" src="assets/frontend/img/home/services/Group34.svg" alt="enpix">
            ...
            <div class="row wow animate__animated animate__fadeInUp animate__delay-1s">
                <div class="col-xl-3 col-sm-6">
                    <div class="service-content">
                        ...
                        <h3 class="heading-5"><a href="services.html">Mobile Apps</a></h3>
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="service-content">
                        ...
                        <h3 class="heading-5"><a href="services.html">Branding Strategy</a></h3>
                        <p class="enpix-body-text-2">We design professional looking yet simple Logo.</p>
                        <a href="services.html">
                            <svg width="37" height="15" viewbox="0 0 37 15" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="service-content">
                        ...
                        <h3 class="heading-5"><a href="services.html">Online Marketing</a></h3>
                        <p class="enpix-body-text-2">We design professional looking yet simple Logo.</p>
                        <a href="services.html">
                            <svg width="37" height="15" viewbox="0 0 37 15" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
