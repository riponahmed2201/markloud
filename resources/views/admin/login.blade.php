...
<head>
    <title>MarkLoud - Login</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta property="og:locale" content="en_US">
    <meta property="og:type" content="article">
    <meta property="og:title" content="MarkLoud - Login">
    ...
    <link rel="stylesheet" href="../..//admincss?family=Inter:300,400,500,600,700">
    <!--end::Fonts-->
...
<body id="kt_body" class="app-blank bgi-size-cover bgi-attachment-fixed bgi-position-center">
    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <style>
            body {
                background-image: url('assets/admin/media/auth/bg10.jpeg');
            }

            [data-bs-theme="dark"] body {
                background-image: url('assets/admin/media/auth/bg10-dark.jpeg');
            }
        </style>
        <!--end::Page bg image-->
            ...
            <div class="d-flex flex-lg-row-fluid">
                ...
                <div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
                    ...
                    <img class="theme-light-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20"
                        src="assets/admin/media/auth/agency.png" alt="">
                    <img class="theme-dark-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20"
                        src="assets/admin/media/auth/agency-dark.png" alt="">
                    <!--end::Image-->
                    ...
                    <div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
                            ...
                            <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form"
                                ...
                                <div class="row g-3 mb-9">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <a href="#"
                                            class="btn btn-flex btn-outline btn-text-gray-700 btn-active-color-primary bg-state-light flex-center text-nowrap w-100">
                                            <img alt="Logo" src="assets/admin/media/svg/brand-logos/apple-black.svg"
                                                class="theme-light-show h-15px me-3">
                                            <img alt="Logo"
                                                src="assets/admin/media/svg/brand-logos/apple-black-dark.svg"
                        ...
                        <div class=" d-flex flex-stack">
                            ...
                            <div class="d-flex fw-semibold text-primary fs-base gap-5">
                                <a href="pages//adminteam.html" target="_blank">Terms</a>

                                <a href="pages//adminpricing/column.html" target="_blank">Plans</a>

                                <a href="pages//admincontact.html" target="_blank">Contact Us</a>
                            </div>
                            <!--end::Links-->
                        </div>
                        <!--end::Footer-->
